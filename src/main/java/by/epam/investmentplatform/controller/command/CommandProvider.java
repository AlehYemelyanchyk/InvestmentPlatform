...
public final class CommandProvider {
    ...
    private CommandProvider() {
        ...
        repository.put(CommandsConstants.ADD_SECURITY_TO_PORTFOLIO_WINDOW + POST_METHOD, new AddSecurityToPortfolioWindowPostCommand());
        ...
        repository.put(CommandsConstants.GET_ALL_SECURITY_TRANSACTIONS + POST_METHOD, new GetAllSecurityTransactionsPostCommand());
        ...
        repository.put(CommandsConstants.GET_SECURITY + POST_METHOD, new GetSecurityPostCommand());
